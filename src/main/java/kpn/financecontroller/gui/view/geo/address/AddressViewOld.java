// TODO: 06.08.2022 del
//package kpn.financecontroller.gui.view.geo.address;
//
...
//
//    @Override
//    protected Result<List<Address>> delete(Address domain) {
//        return addressService.deleter().byId(domain.getId());
//    }
//
//    @Override
//    protected Result<List<Address>> save(Address domain) {
//        return addressService.saver().save(domain);
//    }
//}
