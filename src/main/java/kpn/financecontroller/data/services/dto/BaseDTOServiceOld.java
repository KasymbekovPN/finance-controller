...
// TODO: 14.07.2022 del
public interface BaseDTOServiceOld<DOMAIN, ENTITY, ID, PREDICATE> {
    SaverOld<DOMAIN, ENTITY, ID> saver();
    LoaderOld<DOMAIN, ENTITY, ID> loader();
    DeleterOld<DOMAIN, ENTITY, ID> deleter();
    PredicateExecutorOld<DOMAIN, PREDICATE> executor();
}
