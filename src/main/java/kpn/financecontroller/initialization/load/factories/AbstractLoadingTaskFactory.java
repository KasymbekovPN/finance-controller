...
abstract public class AbstractLoadingTaskFactory<K, E> implements LoadingTaskFactory<K, E> {
    ...
    public AbstractLoadingTaskFactory(PathCalculator<String, String> pathCalculator,
