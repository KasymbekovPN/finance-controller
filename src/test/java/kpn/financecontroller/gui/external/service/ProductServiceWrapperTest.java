...
class ProductServiceWrapperTest {
    ...
    void shouldCheckFinding_ServiceNull() {
        ImmutableResult<List<Product>> expectedResult = ImmutableResult.<List<Product>>fail("service.product.null");

        ProductServiceWrapper.SERVICE = null;
    ...
    void shouldCheckFinding() throws DTOException {
        ...
        ProductServiceWrapper.SERVICE = createService();
        Result<List<Product>> result = new ProductServiceWrapper().find(null);
