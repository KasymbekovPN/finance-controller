...
class LoaderOldAllTest {
    ...
    private static LoaderOldAll<TestModelOld, TestEntityOld, Long> loader;
    private static LoaderOldAll<TestModelOld, TestEntityOld, Long> wrongLoader;
    ...
    static void beforeAll() {
        ...
        loader = new LoaderOldAll<>(createRepo(), LOADER_NAME, TestModelOld::new, toDomains);
        wrongLoader = new LoaderOldAll<>(createWrongRepo(), WRONG_LOADER_NAME, TestModelOld::new, toDomains);
    }
