...
class CollectorTaskTest {
    ...
    private static CollectorTask<Long, String> task;
    ...
    static void beforeAll() {
        ...
        task = new CollectorTask<>(pathCalculator, collectorCreator, PATH, ID);
    }
    ...
    void shouldCheckCollectorGetting() {
        task.fillCollector("");
        IECollector<Long, String> collector = task.getCollector();
    ...
    private static CollectorCreator<Long, String> createCollectorCreator() {
        ...
        Mockito
                ...
                .thenReturn(
                        Result.<IECollector<Long, String>>builder().success(true).code(COLLECTOR_FILLING_CODE).value(new TestCollector(KEY)).build()
                );
    ...
    @AllArgsConstructor
    @EqualsAndHashCode
    private static class TestCollector implements IECollector<Long, String>{
